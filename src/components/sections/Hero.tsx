...
export default function Hero() {
  return (
    <section className="relative pt-28 pb-12 md:pt-32 md:pb-16 overflow-hidden min-h-[85vh] flex flex-col justify-center" id="hero">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10 w-full">
        ...
        <div className="max-w-2xl lg:max-w-3xl mb-8 md:mb-10">
          ...
          <motion.h1 
            ...
            className="font-display font-black text-3xl sm:text-4xl md:text-5xl text-foreground leading-[1.12] mb-4 tracking-tight"
          >
          ...
          >
            <Link
              href="#products"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-foreground text-background font-sans font-bold text-xs uppercase tracking-wider hover:bg-amber hover:text-foreground transition-all rounded-xs shadow-xs"
            >
            ...
            <Link
              href="#contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-border bg-card/80 text-foreground font-sans font-bold text-xs uppercase tracking-wider hover:border-foreground transition-all rounded-xs"
            >
        ...
        {/* Compact Integrated Metric Bar */}
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.3 }}
          className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 pt-6 border-t border-border/80"
        >
          <div className="space-y-0.5">
            <div className="flex items-center gap-1 font-mono text-2xl sm:text-3xl font-black text-amber">
          ...
          <div className="space-y-0.5">
            <div className="flex items-center gap-1 font-mono text-2xl sm:text-3xl font-black text-cobalt">
          ...
          <div className="space-y-0.5">
            <div className="flex items-center gap-1 font-mono text-2xl sm:text-3xl font-black text-emerald-chem">
          ...
          <div className="space-y-0.5">
            <div className="flex items-center gap-1 font-mono text-2xl sm:text-3xl font-black text-foreground">
              <NumberTicker value={100} />
              <span>%</span>
            </div>
            <div className="font-sans text-xs text-muted-foreground uppercase tracking-wider font-semibold">
